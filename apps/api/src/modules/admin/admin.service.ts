...
export class AdminService implements OnModuleInit {
  ...
  private async ensureAdminUser() {
    try {
      ...
      if (admin && admin.role !== Role.ADMIN) {
        ...
        console.log('[AdminService] Ensured admin@mykart.test has ADMIN role.');
      }
    } catch (e: any) {
      console.warn('[AdminService] Admin role check warning:', e?.message || e);
    }
  }
  ...
  async getReviews(skip = 0, take = 20, reported = false) {
    try {
      ...
      const filtered = reported
        ? mapped.filter((r: any) => r.reported)
        : mapped;
      const count = reported ? filtered.length : total;

      return { reviews: filtered, total: count };
    } catch (err: any) {
      console.error('[AdminService.getReviews] error:', err);
  ...
  async updateSettings(dto: any) {
    ...
    const updated = {
      ...
      allowSellerRegistration:
        dto.allowSellerRegistration !== undefined
          ? !!dto.allowSellerRegistration
          : current.allowSellerRegistration,
    };
  ...
  async seedCatalog() {
    ...
    if (!seller) {
      ...
      if (!adminUser) {
        throw new BadRequestException(
          'No admin user found to associate seller',
        );
      }
    ...
    const parentCategories = [
      {
        name: 'Electronics',
        slug: 'electronics',
        description: 'Computers, mobiles and accessories',
      },
      {
        name: 'Fashion',
        slug: 'fashion',
      ...
      },
      {
        name: 'Home & Kitchen',
        slug: 'home-kitchen',
        description: 'Appliances, decor and cooking utilities',
      },
      {
        name: 'Beauty & Personal Care',
        slug: 'beauty-personal-care',
        description: 'Cosmetics, skincare and grooming',
      },
      {
        name: 'Sports & Fitness',
        slug: 'sports-fitness',
        description: 'Gym accessories, cycling and gears',
      },
      {
        name: 'Books',
        slug: 'books',
        description: 'Fiction, academics and self help',
      },
      {
        name: 'Grocery',
        slug: 'grocery',
        description: 'Staples, snacks and household essentials',
      },
      {
        name: 'Gaming',
        slug: 'gaming',
        description: 'Consoles, controller accessories and games',
      },
    ];
    ...
    const catalog = [
      ...
      },
      {
        ...
        cat: 'smartphones',
        brand: 'asus',
        img: 'https://images.unsplash.com/photo-1567581935884-3349723552ca?w=800',
        sku: 'ZF10-256',
        stock: 8,
      },
      {
      ...
      },
      {
        ...
        cat: 'cameras',
        brand: 'sony',
        img: 'https://images.unsplash.com/photo-1500462918059-b1a0cb512f1d?w=800',
        sku: 'SONY-A6700',
        stock: 4,
      },
      {
      ...
      },
      {
        ...
        cat: 'mobile-accessories',
        brand: 'samsung',
        img: 'https://images.unsplash.com/photo-1622445268465-843856586331?w=800',
        sku: 'SAM-25WADA',
        stock: 60,
      },
      {
      ...
      },
      {
        ...
        cat: 'grooming',
        brand: 'philips',
        img: 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=800',
        sku: 'PH-ONEBLADE',
        stock: 50,
      },
      {
      ...
      },
      {
        ...
        cat: 'snacks',
        brand: 'too-yumm',
        img: 'https://images.unsplash.com/photo-1621447504864-d8686e12698c?w=800',
        sku: 'TYUM-MULTI-35G',
        stock: 200,
      },
      {
    ...
    console.log(
      `[seedCatalog] Finished! Total categories: ${totalCats}, Brands: ${totalBrands}, Products: ${totalProducts}`,
    );
  ...
  async seedHistory() {
    ...
    if (!customerUser || !seller) {
      return {
        status: 'ERROR',
        message: 'Customer or Seller not found in DB.',
      };
    }
        ...
        data: {
          ...
          payments: {
            create: [
              {
                provider:
                  spec.payStatus === PaymentStatus.PENDING ? 'COD' : 'RAZORPAY',
                amount: total,
                status: spec.payStatus,
              },
            ],
