        ...
        <div className="rounded-lg border border-border bg-card p-8 shadow-sm sm:p-10">
          ...
          <div className="mt-6">
            <a
              ...
              className="flex h-12 w-full items-center justify-center gap-3 rounded-lg border border-border bg-background font-display text-sm font-semibold text-foreground transition-all hover:bg-secondary active:scale-[0.99] shadow-sm"
            >
