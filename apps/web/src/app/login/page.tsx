    ...
    <div className="flex min-h-[calc(100vh-5rem)] items-center justify-center bg-secondary px-4 py-12 md:min-h-[calc(100vh-6rem)]">
      ...
      >
        <div className="rounded-lg border border-border bg-card p-8 shadow-sm sm:p-10">
          ...
          <a
            href={`${finalApiUrl}/api/v1/auth/google`}
            className="flex h-12 w-full items-center justify-center gap-3 rounded-lg border border-border bg-background font-display text-sm font-semibold text-foreground transition-all hover:bg-secondary active:scale-[0.99] shadow-sm mb-6"
          >
